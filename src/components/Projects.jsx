      ...
      <article className='descriptions'>
        <div className='lineEffect'>
          <div className='container'>
            ...
            Desarrollé una Pokédex con React y Redux que permite a los 
            usuarios buscar y filtrar Pokémon por tipo, así como ver detalles sobre 
            cada uno, con una interfas optima para mejorar la experiencia del 
            usuario. La app está conectada a una API que proporciona información 
            sobre los Pokémon.
            </p>
          </div>
        </div>
